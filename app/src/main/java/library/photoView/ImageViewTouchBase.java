...
public abstract class ImageViewTouchBase extends ImageView implements IDisposable {
	...
	/**
	 * Use this to change the {@link library.photoView.ImageViewTouchBase#setDisplayType(library.photoView.ImageViewTouchBase.DisplayType)} of
	 * this View
	 *
	 * @author alessandro
	 */
	 ...
	 * or the {@link library.photoView.ImageViewTouchBase.DisplayType} has been modified
	 *
	 * @param left
	 * @param top
	 * @param right
