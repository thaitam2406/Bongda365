 ...
 */
public class TouchHighlightTextView extends TextView {
    /**
    ...
    public TouchHighlightTextView(Context context) {
        super(context);
        init();
    }

    public TouchHighlightTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public TouchHighlightTextView(Context context, AttributeSet attrs, int defStyle) {
